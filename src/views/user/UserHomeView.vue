    ...
    <div class="container">
      ...
      <div class="d-flex card-row class-glasses-group mt-48 mt-sm-24">
        <div class="column">
          ...
          <div class="class-glasses-title mt-8">
        ...
        <div class="column">
          ...
          <div class="class-glasses-title mt-8">
            <h2 class="fz-48 text-italic primary-color">FUNCTIONAL</h2>
          </div>
        </div>
      </div>
    </div>
      ...
      <ul class="d-flex card-row recommend-group mt-48 mt-sm-24">
        <li class="column">
          <div class="recommend-card">
            ...
            <div class="recommend-content d-flex flex-direction-column justify-content-space-between p-16">
              <div class="recommend-text">
                <p class="fw-medium">Jessy</p>
                <p class="pt-8">眼鏡品質優良，下次還會想來這邊購買！</p>
              </div>
              <div class="recommend-date">
                <p class="fz-14 gray-color">
                  2021/06/20
                </p>
              </div>
            </div>
        ...
        <li class="column">
          <div class="recommend-card">
            ...
            <div class="recommend-content d-flex flex-direction-column justify-content-space-between p-16">
              <div class="recommend-text">
                <p class="fw-medium">凱倫</p>
                <p class="pt-8">做工細緻、鏡架很輕盈，待久也不會覺得有負擔，推薦給大家！</p>
              </div>
              <div class="recommend-date">
                <p class="fz-14 gray-color">
                  2021/04/18
        ...
        <li class="column">
          <div class="recommend-card">
            ...
            <div class="recommend-content d-flex flex-direction-column justify-content-space-between p-16">
              <div class="recommend-text">
                <p class="fw-medium">悠悠</p>
                <p class="pt-8">謝謝客服人員的詳細回答，成功買到了喜歡的眼鏡，下次會再回購！</p>
              </div>
              <div class="recommend-date">
                <p class="fz-14 gray-color">
                  2020/12/25
        ...
        <li class="column">
          <div class="recommend-card">
            ...
            <div class="recommend-content d-flex flex-direction-column justify-content-space-between p-16">
              <div class="recommend-text">
                <p class="fw-medium">Kyuan</p>
                <p class="pt-8">服務很好，品質沒有任何問題，非常喜歡。</p>
              </div>
              <div class="recommend-date">
                <p class="fz-14 gray-color">
                  2020/10/31
    ...
    <div class="container">
      ...
      <div class="d-flex card-row contact-group justify-content-center">
        <div class="column">
          ...
          <form>
            <label for="person" class="d-block mt-24">
              姓名
            </label>
            <input
              id="person" type="text"
              placeholder="陳小明" name="person"
              class="d-block w-100 mt-8">
            <label for="tel" class="d-block mt-16">
              連絡電話
            </label>
            <input
              id="tel" type="text"
              placeholder="0912-345-678" name="tel"
              class="d-block w-100 mt-8">
            <label for="mail" class="d-block mt-16">
              電子郵件
            </label>
            <input
              id="mail" type="text"
              placeholder="example@email.com" name="mail"
              class="d-block w-100 mt-8">
            <label for="message" class="d-block mt-16">
              意見反應
            </label>
            <input
              id="message" type="text"
              placeholder="請輸入您的意見" name="message"
              class="d-block w-100 mt-8"
